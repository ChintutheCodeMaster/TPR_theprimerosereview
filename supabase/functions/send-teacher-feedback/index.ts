...
<head>
  ...
  <title>Essay Feedback from Your Teacher</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 16px;color:#374151;font-size:16px;line-height:1.7;">
                Your teacher <strong>${teacherName}</strong> has reviewed your essay and left feedback for you.
              </p>
              ...
              <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px 24px;margin-bottom:24px;">
                ...
                <p style="margin:0;color:#111827;font-size:15px;font-weight:600;">${essayLabel}</p>
              </div>
              ...
              <div style="background:#ede9fe;border:1px solid #c4b5fd;border-left:4px solid #7c3aed;border-radius:10px;padding:16px 20px;margin-bottom:28px;">
                <p style="margin:0 0 6px;color:#4c1d95;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;">Message from ${teacherName}</p>
          ...
          <tr>
            <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:20px 40px;text-align:center;">
              <p style="margin:0;color:#9ca3af;font-size:12px;line-height:1.6;">
                You're receiving this because your teacher submitted feedback on one of your essays.<br />
...
serve(async (req) => {
  ...
  try {
    ...
    if (!studentEmail || !studentName || !teacherName || !essayLabel) {
      throw new Error("studentEmail, studentName, teacherName, and essayLabel are required");
    }
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: studentEmail,
        subject: `${teacherName} left feedback on your essay — The Primrose Review`,
        html,
      }),
    });
    ...
    console.error("send-teacher-feedback error:", error);

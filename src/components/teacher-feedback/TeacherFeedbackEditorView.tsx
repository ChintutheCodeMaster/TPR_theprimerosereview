...
import { Loader2, Star, AlertTriangle, Save, Send, Eye } from "lucide-react";
import { EssayHighlightPanel } from "@/components/essay-feedback/EssayHighlightPanel";
import { SuggestionPopover } from "@/components/essay-feedback/SuggestionPopover";
import { TeacherIssuesPanel } from "./TeacherIssuesPanel";
import { TeacherFeedbackDraftPanel } from "./TeacherFeedbackDraftPanel";
import type { TeacherEssayInput, AnalysisResult, AnalysisIssue, FeedbackItem } from "@/hooks/useTeacherEssayFeedback";
...
interface TeacherFeedbackEditorViewProps {
...
export const TeacherFeedbackEditorView = ({
  ...
  saveFeedback, onClearPendingSelection, onShowPreview,
}: TeacherFeedbackEditorViewProps) => {
  return (
    <>

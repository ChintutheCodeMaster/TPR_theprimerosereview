...
import type { FeedbackItem } from "@/hooks/useTeacherEssayFeedback";
import type { TrackedChange } from "@/hooks/useTrackedChanges";

interface TeacherFeedbackDraftPanelProps {

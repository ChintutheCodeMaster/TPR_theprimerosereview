...
import type { AnalysisResult, FeedbackItem } from "@/hooks/useTeacherEssayFeedback";
import type { TrackedChange } from "@/hooks/useTrackedChanges";

interface TeacherFeedbackPreviewViewProps {
  essayTitle: string;
  studentName: string;
...
export const TeacherFeedbackPreviewView = ({
...
}: TeacherFeedbackPreviewViewProps) => {
  return (
    <>
      ...
      <ScrollArea className="flex-1 p-6">
        <div className="space-y-6">
          <div className="text-center pb-4 border-b">
            ...
            <p className="text-muted-foreground">Feedback from your teacher</p>
            {analysis && (

...
export const AchievementLoadingTransition = () => {
  return (
      ...
      <div className="max-w-3xl mx-auto text-center space-y-8">
        <div className="mb-12 relative">
          <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative">
            <motion.div animate={{ y: [0, -10, 0], rotate: [0, -2, 2, 0] }} transition={{ duration: 2.5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut" }}>
              <img src="/lovable-uploads/3190b4a7-96de-4fbb-8aa0-9ac950151fbc.png" alt="Achievement Frame" className="w-72 h-72 object-contain mx-auto" />
            </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="space-y-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#1A1F2C] leading-relaxed">🏆 Remarkable Journey</h2>
          <p className="text-lg sm:text-xl text-neutral-700 max-w-2xl mx-auto leading-relaxed">
            Your proudest achievement is a powerful part of your story. Nearly 70% of successful applicants highlight a moment that changed their perspective or defined their ambition.
          </p>
        </motion.div>
